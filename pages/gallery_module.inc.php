		...
		<?php
			if ($module_id > 0) {
				if (!isset($_REQUEST["install"])) {
					echo '<li><a id="update-module" href="index.php?page=magnific_popup&amp;subpage=gallery_module&amp;install=1&amp;module_id=' . $module_id . '">' . $I18N->msg('magnific_popup_module_update') . '</a></li>';
				}
    		} else {
				if (!isset($_REQUEST["install"])) {
